...
function = tf.pow(X, createCons(2)) + createCons(2) * X * y +createCons(3) \
* tf.pow(y, createCons(2)) + createCons(4) * X + createCons(5) * y + createCons(6)
